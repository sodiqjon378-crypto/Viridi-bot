...
conn = sqlite3.connect("viridi_bot_v2.db", check_same_thread=False)
cursor = conn.cursor()
...
# Render port talabini avtomatik ushlash uchun (o'chib qolmaydi)
...
async def main():
    ...
    print("Bot va veb-server mukammal ishga tushdi...")
