...
conn = sqlite3.connect("viridi_bot_v6.db", check_same_thread=False)
cursor = conn.cursor()
...
async def process_payment(message: Message, state: FSMContext):
    ...
    # Mijozga yuboriladigan yakuniy xabar
...
async def main():
    ...
    await web_server()
    print("Bot yetkazib berish funksiyasi bilan ishga tushdi...")
