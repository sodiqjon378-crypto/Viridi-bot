...
async def show_categories(message: Message):
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="🏠 Uy tozalash (Pol/Gilam)", callback_data="cat_homeclean")],
            [InlineKeyboardButton(text="🍳 Oshxona va yog' ketkazuvchi", callback_data="cat_degreaser")],
...
async def process_name(message: Message, state: FSMContext):
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="Uy tozalash (Pol/Gilam)", callback_data="setcat_homeclean")],
            [InlineKeyboardButton(text="Oshxona/Yog'", callback_data="setcat_degreaser")],
